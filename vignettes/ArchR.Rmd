# A Brief ArchR Tutorial

The following tutorial shows the basics of ArchR using a gold-standard dataset of hematopoietic cells ( CITATION ). This will walk through the basic steps without providing much detail. Please see the Vignettes for additional details on each major step:
