...
#' @param useCoverages QQQ UNCLEAR WHAT HAPPENS WHEN THIS IS FALSE A boolean indicating whether to use group coverages of pseudobulks for track plotting. QQQSee `addGroupCoverages()` for information on plotting ArrowFiles without the use of pseudo-bulk replicates.
