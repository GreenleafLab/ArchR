...
#' @param region A GRanges region that indicates the region to be plotted. If more than one region exists in the GRanges object, only the first will be plotted. If no region is supplied, then the "geneSymbol" argument can be used to center the plot window at the transcription start site of the gene passed to "geneSymbol".
...
#' @param geneSymbol If "region" is not supplied, plotting can be centered at the transcription start site corresponding to the gene symbol passed here.
